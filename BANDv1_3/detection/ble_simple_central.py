...
from detection.ble_advertising import decode_services, decode_name
...
class BLESimpleCentral:
    ...
    def write_received_data_to_file(self, filename, data):
...
def demo():
    ...
    with open("sensors/received_data.txt", 'w') as f:
            f.write('')
            
    print("Connected")

    def on_rx(notify_data):
        print("RX", notify_data)
        central.write_received_data_to_file('sensors/received_data.txt', notify_data)
