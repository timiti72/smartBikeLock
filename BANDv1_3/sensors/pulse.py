...
from max30102 import MAX30102, MAX30105_PULSE_AMP_MEDIUM, MAX30105_PULSE_AMP_OFF
...
def get_pulse_rate():
    ...
    i2c1 = SoftI2C(sda=Pin(18),  scl=Pin(19),  freq=400000,)

    # Sensor instance
    sensor = MAX30102(i2c=i2c1)  # An I2C instance is required

    # Scan I2C bus to ensure that the sensor is connected
    if sensor.i2c_address not in i2c1.scan():
    ...
    while True:
        ...
        if ticks_diff(ticks_ms(), ref_time) / 1000 > hr_compute_interval:
            ...
            sensor.set_active_leds_amplitude(MAX30105_PULSE_AMP_OFF)
